...
# map a value x from one range [a, b] to another range [c, d]. To normalize or scale operations.
...
# Given a node x, this function calculates its neighboring nodes in the map. It ensures that neighbors are within the bounds of the map.
